...
public static class ServiceIndexModelExtensions
{
    ...
    private static readonly string Version350 = "/3.5.0";
    ...
    private static readonly string[] SearchQueryService = { "SearchQueryService" + Version350, "SearchQueryService" + Version340, "SearchQueryService" + Version300beta, "SearchQueryService" };
    ...
    private static readonly string[] SearchAutocompleteService = { "SearchAutocompleteService" + Version350, "SearchAutocompleteService", "SearchAutocompleteService" + Version300beta };
